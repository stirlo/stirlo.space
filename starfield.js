document.addEventListener('DOMContentLoaded', () => {
    ...
    let starArray = []; // Moved declaration here to access it globally within the script

    function resizeCanvas() {
        canvas.width = window.innerWidth;
        canvas.height = window.innerHeight;
        initializeStars(); // Reinitialize stars to adapt to new canvas size
    }
    ...
    initializeStars(); // Initial call to populate the starArray
